...
namespace GameTest1
{
    ...
    public class Game2 : GameBase
    {
        ...
        protected override void LoadContent()
        {
            ...
            GameOverState = new GameOverState(this, _graphics.GraphicsDevice, Content);
        ...
        public new void InitObjects()
        {
            ...
            HunterEnemy huntress = new HunterEnemy(huntersheet,Content.Load<Texture2D>("Arrows/Static") ,WindowRectangle, Level1, new Vector2(38, 5), new Vector2(39, 40),10,1.3f,1);
